...
//! 비동기
// : 동시에 일어나지 않는 방식
// : 특정 코드의 연산이 끝날 때 까지 기다리지 않고 다음 코드를 먼저 실행하는 방식

//? Async/Await와 Promise의 차이

// Async/Await
// : 자바스크립트의 비동기 연산을 처리하는 방법
// : 비동기 코드를 마치 동기적으로 작동하는 것처럼 작성 가능합니다.

// Promise
// : 자바스크립트의 비동기 연산을 처리하는 객체
// : 대기, 이행, 거부 라는 세 가지 상태를 가집니다.
// then(), catch()메서드를 제공하며, 비동기 연산의 결과를 처리

//! 에러 핸들링
// : try...catch문을 사용하여 에러 처리
// : try 블록 안의 코드에서 에러발생 > 제어흐름이 catch 블록으로 이동하고, catch 블록 안의 코드가 실행
